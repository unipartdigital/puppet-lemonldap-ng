...
class lemonldap::config::augeas(
  ...
  $locationchanges = [
    "set dict/entry[. = \"locationRules\"]/dict/entry[1] \"auth.${domain}\"",
    # "set dict/entry[. = \"locationRules\"]/dict/entry[1]/dict/entry[1] \"(?#checkUser)^/checkuser\"",
    # "set dict/entry[. = \"locationRules\"]/dict/entry[1]/dict/entry[1]/string \"debug\"",
    # "set dict/entry[. = \"locationRules\"]/dict/entry[1]/dict/entry[2] \"(?#errors)^/lmerror/\"",
    # "set dict/entry[. = \"locationRules\"]/dict/entry[1]/dict/entry[2]/string \"accept\"",
    # "set dict/entry[. = \"locationRules\"]/dict/entry[1]/dict/entry[3] \"default\"",
    # "set dict/entry[. = \"locationRules\"]/dict/entry[1]/dict/entry[3]/string \"accept\"",
    "set dict/entry[. = \"locationRules\"]/dict/entry[2] \"manager.${domain}\"",
    # "set dict/entry[. = \"locationRules\"]/dict/entry[2]/dict/entry[1] \"(?#Configuration)^/(.*?\\.(fcgi|psgi)/)?(manager\\.html|confs/|$)\"",
    # "set dict/entry[. = \"locationRules\"]/dict/entry[2]/dict/entry[1]/string \"debug\"",
    # "set dict/entry[. = \"locationRules\"]/dict/entry[2]/dict/entry[2] \"(?#Notifications)/(.*?\\.(fcgi|psgi)/)?notifications\"",
    # "set dict/entry[. = \"locationRules\"]/dict/entry[2]/dict/entry[2]/string \"debug\"",
    # "set dict/entry[. = \"locationRules\"]/dict/entry[2]/dict/entry[3] \"(?#Sessions)/(.*?\\.(fcgi|psgi)/)?sessions\"",
    # "set dict/entry[. = \"locationRules\"]/dict/entry[2]/dict/entry[3]/string \"debug\"",
    # "set dict/entry[. = \"locationRules\"]/dict/entry[2]/dict/entry[4] \"default\"",
    # "set dict/entry[. = \"locationRules\"]/dict/entry[2]/dict/entry[4]/string \"debug\"",
    ...
    # "set dict/entry[. = \"locationRules\"]/dict/entry[. = \"manager.${domain}\"]/dict/entry[1]/string \"groupMatch($hGroups, 'cn', '${ldap_admin_group}')\"",
